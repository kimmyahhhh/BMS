<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_blotter_updated.aspx.cs" Inherits="blotter.blotter" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="admin_blotter_updated.css"/>
    <style>
        .modal {
            display: none;
                            ...
                            <asp:GridView ID="adminblotterGV" runat="server" CssClass="gridview-style" DataKeyNames="res_id, blotter_id" AutoGenerateColumns="False" OnRowCommand="adminblotterGV_RowCommand" OnRowDataBound="adminblotterGV_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Settled">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEnded" runat="server" Text='<%# GetEndedText(Eval("status").ToString(), Eval("ended")) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
